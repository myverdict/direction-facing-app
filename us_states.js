/*
    Data taken from: (December 06, 2021)
    JSON Array with List of US States with 2-char ISO codes. (By tvpmb)
...
let usaStates = [
    ...
    { "name": "District of Columbia", "alpha-2": "DC" },    // US capital: not a state
